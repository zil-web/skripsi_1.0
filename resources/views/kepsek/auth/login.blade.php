...
@section('content')
    ...
    <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4" style="background-color: #7C3AED;">
    ...
    <div class="mt-8 pt-6 border-t border-gray-200">
        <p class="text-center text-sm text-gray-600">
            ...
            <a href="{{ route('login') }}" class="font-semibold hover:underline" style="color: #7C3AED;">
                Login sebagai Admin
            </a>
        </p>
    </div>
